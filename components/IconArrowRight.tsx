/**
 * Webflow export asset `images/692677644b6afeff7e993635_Back-To-Top.svg`
 * (used across buttons / links in the original site).
 */

type IconArrowRightProps = {
  className?: string;
  /** `right` for buttons/links; `up` for legacy diagonal use with rotate-45 */
...
export default function IconArrowRight({
  ...
  return (
    ...
    >
      <g transform={orientation === "right" ? "rotate(90 7.5 7.5)" : undefined}>
        <path
